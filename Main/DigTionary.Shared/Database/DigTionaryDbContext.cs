...
namespace DigTionary.Shared.Database;

internal sealed partial class DigTionaryDbContext(DbContextOptions<DigTionaryDbContext> _options) : DbContext(_options)
{
